...
#cur.execute("insert into paymentsf values(1,'Rakesh,Sunil,Pankaj','Khare','9589861196','Rakesh,Sunil,Pankaj7673@gmail.com',2,'1','11','2018','11:20:27 PM','Cash','3500')")
...
# Label(sroot,text="Rakesh,Sunil,Pankaj Khare",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
# Label(sroot,text="Rakesh,Sunil,Pankaj7673@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	root.title("Made by Rakesh,Sunil,Pankaj")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Rakesh,Sunil,Pankaj',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Sunil Kashyap",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="Ms. Pankaj",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		Label(emp1inf,text="Mr. Rakesh Singh Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
